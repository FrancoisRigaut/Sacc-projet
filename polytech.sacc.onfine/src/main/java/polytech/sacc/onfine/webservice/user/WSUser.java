...
@WebServlet(name = "WSUser", value = "/ws/user/*")
public class WSUser extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            switch (parsing[1]) {
                case "register":
                    handleRegisterUser(req, resp, "/" + requestURL);
                    break;
                default:
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            switch (parsing[1]) {
                case "set-poi":
                    handleSetPoi(req, resp, "/" + requestURL);
                    break;
                default:
                    throw new WrongArgumentException(parsing[2]);
            }
    ...
    private void handleRegisterUser(HttpServletRequest req, HttpServletResponse resp, String requestUrl) throws IOException{
    ...
    private void handleSetPoi(HttpServletRequest req, HttpServletResponse resp, String requestUrl) throws IOException{
        JsonObject jsonObject = (JsonObject) NetUtils.getGsonEntity(req, JsonObject.class);
        try{
